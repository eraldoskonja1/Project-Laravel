...
export default function ShperndarjeUrgjente({ auth, users }) {
    ...
    return (
        <AuthenticatedLayout user={auth.user}>
            <Head title="ShperndarjeUrgjente" />
                        ...
                        <table className="min-w-full bg-white border rounded-md">
                            <thead>
                                <tr>
                                    ...
                                    <th className="px-4 py-2">Kontrata te kontrolluara</th>
                                    <th className="px-4 py-2">Kontrata te pakontrolluara</th>
                                    <th className="px-4 py-2">Kontrata totale</th>
                                </tr>
                            </thead>
                            <tbody>
                                {data && data.map((row) => (
